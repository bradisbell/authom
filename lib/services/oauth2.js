...
OAuth2.prototype.parseURI = function(request) {
  ...
  if(parts.query.caller_redirect) {
    this.caller_redirect = parts.query.caller_redirect;
    this.state = parts.query.state;
    delete parts.query.caller_redirect;
    delete parts.query.state;
    delete parts.search;
    request.url = url.format(parts);
  }
